...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post creators_url, params: { creator: { comment_id: @creator.comment_id, name: @creator.name } }
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { comment_id: @creator.comment_id, name: @creator.name } }
